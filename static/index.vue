            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td
                  class="text-center"
                  auto-width
                  v-text="itemPrice(props.row.price, props.row.unit)"
                ></q-td>
                <q-td auto-width>
                  <q-btn
                    flat
        ...
        <q-card-section class="q-pa-none text-center">
          ...
          <div v-if="printItems.length > 0" class="row q-gutter-sm q-my-md">
            <q-btn
              ...
              color="secondary"
              :href="
                '/offlineshop/print?items=' +
                printItems.map(({id}) => id).join(',')
              "
            >
              Print QR Codes
            </q-btn>
        ...
        <q-card-section class="q-py-sm text-center">
          ...
          <div v-else-if="confirmationMethod === 'none'">
            <p>
              ...
              appears in the consumer wallet after a purchase is paid for. It's
              ok if the consumer is to be trusted when they claim to have paid.
            </p>
      ...
      <q-card>
        <q-card-section>
          <h6 class="text-subtitle1 q-my-none">
            <span v-text="siteTitle"></span> OfflineShop extension
          </h6>
        </q-card-section>
              ...
              <q-card>
                <q-card-section>
                  <ol>
                    ...
                    <li>
                      Print QR codes and paste them on your store, your menu,
                      somewhere, somehow.
                    </li>
                    <li>
                      Clients scan the QR codes and get information about the
                      items plus the price on their phones directly (they must
                      have internet)
                    </li>
                    <li>
                      Once they decide to pay, they'll get an invoice on their
                      phones automatically
                    </li>
                    <li>
                      When the payment is confirmed, a confirmation code will be
                      issued for them.
                    </li>
                  </ol>
                  <p>
                    The confirmation codes are words from a predefined
                    sequential word list. Each new payment bumps the words
                    sequence by 1. So you can check the confirmation codes
                    manually by just looking at them.
                  </p>
                  <p>
                    For example, if your wordlist is
                    <code>[apple, banana, coconut]</code> the first purchase
                    will be <code>apple</code>, the second <code>banana</code>
                    and so on. When it gets to the end it starts from the
                    beginning again.
                  </p>
                ...
                <q-card>
                  <q-card-section>
                    ...
                    <code>
                      ...
                      <span v-text="g.user.wallets[0].inkey"></span>" -d
                      '{"name": &lt;string&gt;, "description": &lt;string&gt;,
                      "image": &lt;data-uri string&gt;, "price":
              ...
              >
                <q-card>
                  <q-card-section>
                    ...
                    <code>
                      {"id": &lt;integer&gt;, "wallet": &lt;string&gt;,
                      "wordlist": &lt;string&gt;, "items": [{"id":
                      &lt;integer&gt;, "name": &lt;string&gt;, "description":
                      &lt;string&gt;, "image": &lt;string&gt;, "enabled":
                      &lt;boolean&gt;, "price": &lt;integer&gt;, "unit":
                      &lt;string&gt;, "lnurl": &lt;string&gt;}, ...]}&lt;
                    </code>
                    <h5 class="text-caption q-mt-sm q-mb-none">Curl example</h5>
                    <code>
                      curl -X GET
                      <span v-text="baseUrl"></span
                      >offlineshop/api/v1/offlineshop -H "X-Api-Key:
      ...
      <q-card class="q-pa-lg q-pt-xl lnbits__dialog-card">
        <q-card-section>
          <h5
            class="q-ma-none"
            v-text="
              itemDialog.data.id ? itemDialog.data.name : 'Adding a new item'
            "
          ></h5>
          <lnbits-qrcode
            ...
            <div class="row q-mt-lg">
              <div class="col q-ml-lg">
                <q-btn
                  ...
                  type="submit"
                >
                  {{ itemDialog.data.id ? 'Update' : 'Add' }} Item
                </q-btn>
              </div>
              <div class="col q-ml-lg">
